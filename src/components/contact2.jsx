...
export default () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Set your Web3Forms access key here
        const accessKey = "193ed288-672d-49a7-bf56-3f49e870589d";

        // Prepare form data for submission
        const formBody = new FormData();
        formBody.append("access_key", accessKey);
        ...
        try {
            ...
            setFormStatus({ status: "error", message: "An error occurred. Please try again." });
        }
    };
                ...
                <div className="max-w-screen-xl mx-auto px-4 text-gray-300 md:px-8">
                    <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
                        <div className="max-w-lg space-y-3">
                            <h3 className="text-gray-300 font-semibold">Contact</h3>
                        ...
                        <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                            ...
                            {formStatus.message && (
                                <p className={`mt-4 text-${formStatus.status === "success" ? "green" : "red"}-500`}>
                                    {formStatus.message}
                                </p>
                            )}
                        </div>
...
//                 </svg>
//             ,
//             contact: "+91 9911 320 395, +91 7007 535 979"
//         },
//         {
//             icon:
//                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
