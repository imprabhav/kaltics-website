        ...
        <div className="w-full">
          ...
          <div class="lg:mt-24 mt-10 bg-gradient-to-l from-violet-600 to-indigo-600 p-12 rounded-2xl ">
            <div class="lg:flex items-center justify-between gap-6">
              ...
              <button onClick={() => openMailClient2()} class="px-2.5 h-14 flex items-center justify-center text-indigo-600 text-lg font-semibold leading-7 gap-2 rounded-full bg-white whitespace-nowrap"> Send Your CV <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
