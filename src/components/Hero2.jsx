                ...
                <section>
                    <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
                        ...
                        <div className='flex-1 hidden md:block'>
                            ...
                            <div className="card relative w-48 h-64 bg-black flex flex-col justify-end p-3 gap-3 rounded-lg cursor-pointer text-white">
            {/* <p className="heading text-xl capitalize font-bold">Popular this month</p>
            <p className="text-sm">Powered By</p> */}
            <p className="heading text-xl capitalize font-bold text-[#e81cff]">Uiverse</p>
        </div>
                        </div>
                    </div>
                </section>
